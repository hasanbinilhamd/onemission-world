...
import { uploadMovementImage, MovementImageUploadError, MOVEMENT_IMPACT_UPLOAD_FOLDER } from '@/lib/imagekit';
...
/**
 * HQ server-side ImageKit upload for the movement Impact CMS.
 * Reuses the exact same upload infrastructure as Home and Mission.
 */
  ...
  return withDevTiming(request, async () => {
    ...
    try {
      ...
      const result = await uploadMovementImage({
        ...
        mimeType: file.type,
        field,
        folder: MOVEMENT_IMPACT_UPLOAD_FOLDER,
      });

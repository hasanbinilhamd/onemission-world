...
export function getMidtransRefundBaseUrl(orderId) {
  const baseUrl = paymentAttemptConfig.midtransIsProduction
    ? 'https://api.midtrans.com/v2'
    : 'https://api.sandbox.midtrans.com/v2';

  return `${baseUrl}/${encodeURIComponent(String(orderId || '').trim())}/refund`;
}

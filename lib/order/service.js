  ...
  buildOrderResponse(order, { allowReviewActions = false } = {}) {
    ...
    return {
      ...
      shipping: {
        ...
        shippingOriginId: order.shippingOriginId || '',
        shippingDestinationId: order.shippingDestinationId || '',
    ...
    try {
      return await this.prisma.order.create({
        data: {
          ...
          shippingProvider: resolvedCheckoutSession.shippingProvider || 'rajaongkir',
          shippingOriginId: resolvedCheckoutSession.shippingOriginId || '',
          shippingDestinationId: resolvedCheckoutSession.shippingDestinationId || '',
    ...
    try {
      const order = await this.prisma.order.create({
        data: {
          ...
          shippingProvider: checkoutSession.shippingProvider || 'rajaongkir',
          shippingOriginId: checkoutSession.shippingOriginId || '',
          shippingDestinationId: checkoutSession.shippingDestinationId || '',

 ...
 */
export function sortImpactStoriesForPublic(items = []) {
  return [...items].sort((left, right) => {
    const leftPriority = IMPACT_STATUS_PRIORITY[left.status] ?? 99;
    const rightPriority = IMPACT_STATUS_PRIORITY[right.status] ?? 99;

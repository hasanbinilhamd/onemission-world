...
function eventDefinition(type, payload = {}) {
  const definitions = {
    ...
    [NOTIFICATION_EVENT_TYPE.REFUND_REQUESTED]: {
      ...
      message: `Refund request was submitted for order ${payload.publicOrderNumber || payload.orderNumber || ''} by ${payload.customerName || 'customer'}.`,
      actionUrl: 'refundrequests',
      actionLabel: 'Open Refund Requests',
      referenceId: payload.publicOrderNumber || payload.orderNumber || '',
    },

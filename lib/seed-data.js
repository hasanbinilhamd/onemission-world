...
export const SEED_FINANCIAL_ACCOUNTS = [
  { id: uuid(), name: 'Cash',         type: 'Cash', accountNumber: '',             bankName: '',        openingBalance: 0, description: 'Physical cash on hand',  isActive: true },
  { id: uuid(), name: 'Bank BCA',     type: 'Bank', accountNumber: '1234567890',   bankName: 'BCA',     openingBalance: 0, description: 'BCA main business account', isActive: true },
  { id: uuid(), name: 'Bank Mandiri', type: 'Bank', accountNumber: '0987654321',   bankName: 'Mandiri', openingBalance: 0, description: 'Mandiri operational account', isActive: true },
];
...
// ── Sales Channels seed data ──────────────────────────────────────────────
export const SEED_SALES_CHANNELS = [
  { id: uuid(), channelCode: 'SC-0001', channelName: 'Website', channelType: 'Ecommerce', description: 'Official ONEMISSION website store', status: 'Active', isDefault: true },
  { id: uuid(), channelCode: 'SC-0002', channelName: 'Shopee', channelType: 'Marketplace', description: 'Shopee marketplace channel', status: 'Active', isDefault: false },
  { id: uuid(), channelCode: 'SC-0003', channelName: 'Tokopedia', channelType: 'Marketplace', description: 'Tokopedia marketplace channel', status: 'Active', isDefault: false },
  { id: uuid(), channelCode: 'SC-0004', channelName: 'TikTok Shop', channelType: 'Marketplace', description: 'TikTok Shop channel', status: 'Active', isDefault: false },
  { id: uuid(), channelCode: 'SC-0005', channelName: 'Offline Store', channelType: 'Offline Store', description: 'Physical offline retail store', status: 'Active', isDefault: false },
  { id: uuid(), channelCode: 'SC-0006', channelName: 'Reseller', channelType: 'Reseller', description: 'Reseller network channel', status: 'Active', isDefault: false },
  { id: uuid(), channelCode: 'SC-0007', channelName: 'School Partnership', channelType: 'Partnership', description: 'Sales through school partnership programs', status: 'Active', isDefault: false },
];

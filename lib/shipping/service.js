...
export class ShippingService {
  ...
  async getShippingCost(payload) {
    ...
    const destinationPostalCode = payload?.destinationPostalCode || payload?.destination_postal_code || payload?.postalCode;
    ...
    return measure('/shipping/cost', async () => {
      return await this.provider.getShippingCost({
        ...
        destinationPostalCode: destinationPostalCode ? String(destinationPostalCode) : '',
